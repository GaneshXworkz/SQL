...
CREATE TABLE indian_premier_League_Tablel(Sl_no int, team varchar(20), matchs int, win int, Lose int, tai int, Net_Rate int, requried_runrate float, points int);
